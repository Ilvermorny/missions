    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            if (isset($_REQUEST['id']) and is_numeric($_REQUEST['id'])) {
                ...
                $query = sprintf("SELECT * FROM mision WHERE id = '%s' LIMIT 1", $_REQUEST['id']);
                ...
                if ($acceso)
                {
                    ...
                    echo sprintf("<input type='hidden' value='%s' name='mision'>", $_REQUEST['id']);
                ...
                $tmpquery = sprintf("SELECT * FROM mybb_users WHERE uid = '%s'", $mision['user']);
                ...
                <table class="table table-hover">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td>";
                            $tmpquery = sprintf("SELECT * FROM mybb_users WHERE uid = '%s'", $row['id_user']);
                            $resultadoTemp = $db2->query($tmpquery);
                            $arrayResulado = mysqli_fetch_array($resultadoTemp);
                           ...
                           // echo "<td>";
                            ...
                            //$query_user = sprintf("SELECT * from users WHERE id = '%s' LIMIT 1",$row['user']);
                            //$resultuser = $db->query($query_user);
